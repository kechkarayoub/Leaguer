...
class EnvironmentTestCase(TestCase):
    ...
    def test_required_env_variables(self):
        ...
        required_vars = [
            ...
            "EMAIL_HOST_PASSWORD", "EMAIL_HOST_USER", "EMAIL_PORT", "EMAIL_USE_TLS",
            ...
            "REDIS_CONTAINER_EXTERNAL_PORT", "REDIS_CONTAINER_INTERNAL_PORT", "REDIS_URL",
            "TECHNICAL_SERVICE_EMAIL", "USE_DEBUG_TOOLBAR", "WHATSAPP_INSTANCE_ID",
            "WHATSAPP_INSTANCE_TOKEN", "WHATSAPP_INSTANCE_URL", "WS_EXTERNAL_PORT",
            "WS_INTERNAL_PORT",
        ]
