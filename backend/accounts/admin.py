...
class UserAdmin(BaseUserAdmin):
    ...
    def logout_selected_users(self, request, queryset):
        ...
        logger.info(f"Admin action: {users_logged_out} users logged out by {request.user.username}")
    ...
    def deactivate_and_logout_users(self, request, queryset):
        ...
        logger.info(f"Admin action: {users_processed} users deactivated and logged out by {request.user.username}")
    
    deactivate_and_logout_users.short_description = _("Deactivate and logout selected users")
