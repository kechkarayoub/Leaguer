...
def send_verification_email(user, handle_send_email_error=False, do_not_mock_api=False):
    ...
    context.update({
        "email_title": _("Verify Your Email Address"), "user": user,
        "verification_url": verification_url,
    })
    # context['logo_url'] = "https://kkmediafilesprod.s3.amazonaws.com/assets/thumbs"
    # "/mohamed2_1699526271550_16995262403696774211444867641754.jpg"
...
def validate_password_reset_token(uid, token): # pylint: disable=too-many-return-statements
    """
